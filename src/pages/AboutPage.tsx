        ...
        <div className="-mt-20">
            <div className="w-full">
                <div className="flex items-center justify-between">
                    ...
                    <div className="font-helvetica absolute left-1/2 -translate-x-1/2 transform text-2xl leading-relaxed font-bold text-white hidden md:block">О приложении</div>
                ...
                <div className="font-helvetica mt-3 md:hidden text-2xl leading-relaxed font-bold text-white block">О приложении</div>
            </div>
            ...
            <div>
                ...
                <div className="wrap mt-6 flex flex-col sm:mt-8 md:flex-row">
                    ...
                    <div className="flex flex-1 flex-col sm:items-center sm:justify-between md:flex-row">
                        <p className="sm:text-[35px mb-4 text-xl text-[28px] leading-[20px] font-normal text-white" style={{ fontFamily: 'Teletactile, sans-serif' }}>
                            <label className="font-teletactile text-[40px] leading-[40px] font-normal text-white sm:text-[57px] sm:leading-[57px]">20+</label>
                            <span className="ml-[5px]">языков</span>
                        </p>
